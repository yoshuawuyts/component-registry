...
2. **Check .config/impeccable/.impeccable.md (fast)**: If not in instructions, read `.config/impeccable/.impeccable.md` from the project root. If it exists and contains the required context, proceed.
